    ...
    <div className="mt-5 p-2 ">
      ...
      <div className="d-flex  text-center total">
        <div className=" total_1 mt-5" >
              <img src={product.images} alt="Card image Is Avaliable"  className="img-fluid rounded mx-auto d-block" />
        </div>
        <div className="total_2" >
             <div className="all d-flex">
                  ...
                  <Link to="/category" class="btn btn-primary mt-4 "><IoArrowBackOutline className="mx-2 mb-1"/>Back</Link>
